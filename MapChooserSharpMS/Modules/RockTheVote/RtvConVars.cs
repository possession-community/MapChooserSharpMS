...
internal sealed class RtvConVars
{
    ...
    {
        CommandUnlockTimeNextMapConfirmed = cvm.CreateConVar("mcs_rtv_command_unlock_time_next_map_confirmed", 60.0F, 0.0F, 1200.0F, "Seconds to take unlock RTV command after next map confirmed in vote", ConVarFlags.None)!;
        CommandUnlockTimeMapNotChanged = cvm.CreateConVar("mcs_rtv_command_unlock_time_map_dont_change", 240.0F, 0.0F, 1200.0F, "Seconds to take unlock RTV command after map is not changed in rtv vote", ConVarFlags.None)!;
        CommandUnlockTimeMapExtend = cvm.CreateConVar("mcs_rtv_command_unlock_time_map_extend", 120.0F, 0.0F, 1200.0F, "Seconds to take unlock RTV command after map is extended in vote", ConVarFlags.None)!;
        CommandUnlockTimeMapStart = cvm.CreateConVar("mcs_rtv_command_unlock_time_map_start", 300.0F, 0.0F, 1200.0F, "Seconds to take unlock RTV command after map started", ConVarFlags.None)!;
