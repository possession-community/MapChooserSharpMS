...
internal sealed class MapConfigGenerationService: IMapConfigGenerationService
{
    ...
    private void WriteDefaultConfig(string configPath)
    {
...
";
        ...
        File.WriteAllText(ConfigFIleLocation, defaultConfig);
    }
}